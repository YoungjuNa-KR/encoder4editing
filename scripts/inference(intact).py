...
if __name__ == "__main__":
    ...
    parser.add_argument("--images_dir", type=str, default='/home/vimlab/Downloads/mpii_train_45000/',
                        help="The directory of the images to be inverted")
    parser.add_argument("--save_dir", type=str, default='./infer_mpii_to_test/',
